...
import { displayDate, levelDisplay } from '../utils';
import {
  Chart as ChartJS,
  RadialLinearScale,
  ArcElement,
        ...
        {!loading && step === enumStep.creditCard && <div style={styles.AppContain}>
          ...
          <div style={styles.content}>
            <Timeline style={{ padding: '10px' }}>
              <Timeline.Item color="green">{displayDate(new Date().toString())} - Coffee offer to @LabewCoffee</Timeline.Item>
              <Timeline.Item color="green">{displayDate(new Date().toString())} - Chocolate from Adviser #E564</Timeline.Item>
              <Timeline.Item color="blue">{displayDate(new Date().toString())} - Bag from Adviser #F265</Timeline.Item>
              <Timeline.Item color="blue">{displayDate(new Date().toString())} - Shoes from Adviser #CA56</Timeline.Item>
              <Timeline.Item color="blue">{displayDate(new Date().toString())} - Bag from Adviser #XWAK</Timeline.Item>
              <Timeline.Item color="red">{displayDate(new Date().toString())} - Underclothes from Adviser #AA5X</Timeline.Item>
              <Timeline.Item color="grey">{displayDate(new Date().toString())} - Game for Cats from Adviser #SOJA</Timeline.Item>
              <Timeline.Item color="red">{displayDate(new Date().toString())} - Tools from Adviser #WAWA</Timeline.Item>
            </Timeline>
